from tests.test_IIAEService_logic import test_logic_service_with_compatible_distribution, _build_logic_service
...
if __name__ == "__main__":
    ...
    from tests.test_IIAEService_logic import MockAuditInput
    import numpy as np
