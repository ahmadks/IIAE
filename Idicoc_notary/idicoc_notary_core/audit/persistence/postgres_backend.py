...
class PostgresCTMStorage(CTMStorageBackend):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        # El analizador estático puede rastrearlos correctamente a través de todos los paths.
        self._conn_module: Optional[Any] = None
        self._cursor_factory: Optional[Any] = None
